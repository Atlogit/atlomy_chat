...
class TLGParser:
    ...
    def _replace_tlg_refs(self, text):
        ...
        def repl(match):
            ...
            print(f"Author: {author_name}, Work: {work_name}")
            print(self.work_numbers.get(f"TLG{author_id}", {}).get(work_id, "Unknown Work"))
    ...
    def process_texts(self, texts):
        ...
        if isinstance(texts, str):
            print("Processing a single text")
            #print(texts)
            return self._replace_tlg_refs(texts)
        elif isinstance(texts, list):
            print("Processing a list of texts")
    ...
    def process_file(self, input_file_path, output_file_path=None):
        ...
        with open(input_file_path, 'r', encoding='utf-8') as file:
            for line in file:
                ...
                processed_text = self._bibliography_filter(text)
